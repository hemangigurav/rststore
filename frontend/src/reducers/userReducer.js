...
USER_DETAIL_BYID_REQUEST, USER_DETAIL_BYID_SUCCESS, USER_DETAIL_BYID_FAIL, USER_DETAIL_BYID_RESET,} 
from '../constants/userConstants';




//state bydefault empty obj
...
export const userDeleteReducer = (state = {}, action) => {
    switch (action.type){
        ...
        case USER_DELETE_SUCCESS:
            return { loading: false, success:true}; // when the state is empty we can jus pass succes:true to update the page
...
export const userDetailByIdReducer = (state = {user: {} }, action) => {
    switch (action.type){
        case USER_DETAIL_BYID_REQUEST:
            return {...state, loading: true};
        case USER_DETAIL_BYID_SUCCESS:
            return {loading: false, user: action.payload};
        case USER_DETAIL_BYID_FAIL:
            return {loading: false, error: action.payload};
        case USER_DETAIL_BYID_RESET:
            return { user: {} };
        default:
            return state;
    }
