import {
Button, Flex, FormControl, FormLabel, Grid, Heading, Input,	Link, Spacer, Text,
Table, Thead, Tr, Th, Td, Tbody, Icon,
...
const ProfileScreen = () => {
    ...
    useEffect(() => {
		if (!userInfo) {
			...
			if (!user.name) //empty obj is always true hence we have used user.name
             {
    ...
    // if success changes refresh the page
